...
<template>
    <AppLayout>
        ...
        <Head>
            <title>Biggest Golang Job Board - Find Your Perfect Job</title>
        ...
        <section class="bg-gray-100 px-4 py-12">
            ...
            <div class="text-center" v-if="jobs.links.next">
                <Link class="relative inline-flex items-center px-4 py-2 rounded-full text-sm font-medium text-gray-700 bg-white border border-gray-300 hover:text-gray-500 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150"
                      :href="route('job.index', {'page': 2})">More »
                </Link>
            </div>
