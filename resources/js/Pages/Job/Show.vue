...
<template>
    <AppLayout>
        ...
        <section id="apply" class="px-5 py-16 bg-gray-100">
            <div class="shadow-xl p-4 rounded-xl max-w-xl mx-auto bg-white">
                <ApplyForm :job-slug="job.data.slug"></ApplyForm>
            </div>
        </section>
